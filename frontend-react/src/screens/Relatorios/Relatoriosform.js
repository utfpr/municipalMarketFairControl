...
class RelatoriosForm extends PureComponent {
...
const WrappedHorizontalRelatoriosForm = Form.create({ name: 'relatorios_form' })(RelatoriosForm);

export default WrappedHorizontalRelatoriosForm;